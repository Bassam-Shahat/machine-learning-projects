...
def write_text(formatted_text,fullpath):
    """
    ...
    with open(fullpath+'.doc', 'a', newline="") as file:
...
if __name__ == "__main__":
    ...
    outPath = "..\OCR_results"
    path = "..\Managed_Service_SOW"

    # iterate through the names of contents of the folder

    for image_path in sorted_alphanumeric(os.listdir(path)):
        ...
        write_text(arranged_text,outPath+"\\"+'result')
